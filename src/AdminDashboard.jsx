...
const AdminDashboard = () => {
  ...
  const fetchBooks = async () => {
    const res = await fetch("https://lybrary3-0.onrender.com/api/books");
    setBooks(await res.json());
  };

  const fetchStudents = async () => {
    const res = await fetch("https://lybrary3-0.onrender.com/api/auth/students");
    setStudents(await res.json());
  };

  const fetchAssignments = async () => {
    const res = await fetch("https://lybrary3-0.onrender.com/api/assignments");
  ...
  const addBook = async () => {
    ...
    await fetch("https://lybrary2-0-1.onrender.com/api/books/add", {
      method: "POST",
  ...
  const assignBook = async () => {
    ...
    await fetch("https://lybrary3-0.onrender.com/api/assignments/assign", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
